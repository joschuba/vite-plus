      ...
      rows: [
        {
          ...
          description: [
            ...
            `- Default: ${accent('vite:monorepo')}, ${accent('vite:application')}, ${accent('vite:library')}, ${accent('vite:doc')}, ${accent('vite:generator')}`,
  ...
  sections: [
    {
      ...
      rows: [
        ...
        { label: 'vite:doc', description: 'Create a documentation site (VitePress)' },
